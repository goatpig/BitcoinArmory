...
if not USE_TESTNET and not USE_REGTEST:
   ...
   BLOCKEXPLORE_URL_TX   = 'https://testnet.blockexplorer.com/tx/%s' if USE_TESTNET else 'http://noexplorer.none/%s'
   BLOCKEXPLORE_URL_ADDR = 'https://testnet.blockexplorer.com/address/%s' if USE_TESTNET else 'http://noexplorer.none/addr/%s'
